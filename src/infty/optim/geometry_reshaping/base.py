...
class InftyBaseOptimizer(torch.optim.Optimizer):
    ...
    def get_execution_path_metadata(self):
        return {
            "backward_graph_avoided": False,
            "verification_mode": "code_path",
            "execution_path": "InftyBaseOptimizer.set_closure -> torch.enable_grad -> total_loss.backward -> base_optimizer.step",
            "graph_context": "autograd_backward",
        }
